...
class Category(models.Model):
    ...
    # image_cat_1 = models.ImageField(upload_to='Categories', null=True)
    # image_cat_2 = models.ImageField(upload_to='Categories', null=True)
    # image_cat_3 = models.ImageField(upload_to='Categories', null=True)
    # image_cat_4 = models.ImageField(upload_to='Categories', null=True)
